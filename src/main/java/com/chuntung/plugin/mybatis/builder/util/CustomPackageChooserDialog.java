...
public class CustomPackageChooserDialog extends PackageChooser {
    ...
    private Set<? extends JpsModuleSourceRootType<?>> myRootTypes;
    private String sourceDir;

    public CustomPackageChooserDialog(String title, @NotNull Module module) {
    ...
    public CustomPackageChooserDialog(String title, Project project, Set<? extends JpsModuleSourceRootType<?>> rootTypes, String sourceDir) {
        super(project, true);
    ...
    protected JComponent createCenterPanel() {
        ...
        ActionToolbar toolBar = ActionManager.getInstance().createActionToolbar(CustomPackageChooserDialog.class.getSimpleName(), group, true);
    ...
    private void createTreeModel() {
        ...
        fileIndex.iterateContent(
                fileOrDir -> {
                    if (fileOrDir.isDirectory() && fileOrDir.getPath().startsWith(sourceDir)
                            && fileIndex.isUnderSourceRootOfType(fileOrDir, myRootTypes)) {

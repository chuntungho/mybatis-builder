...
public class CustomPackageChooserDialog extends PackageChooser {
  ...
  public CustomPackageChooserDialog(String title, Project project, Set<? extends JpsModuleSourceRootType<?>> rootTypes) {
    super(project, true);
    setTitle(title);
    myTitle = title;
    myProject = project;
  ...
  private void createTreeModel() {
    ...
    fileIndex.iterateContent(
      fileOrDir -> {
        if (fileOrDir.isDirectory() && fileIndex.isUnderSourceRootOfType(fileOrDir, myRootTypes)) {
